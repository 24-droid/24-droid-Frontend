  ...
  return (
    <div>
        ...
        <div className='flex ml-2 flex-col gap-10 justify-evenly md:flex-row mt-5 hover:cursor-pointer'>
            <div>
                <img src={New1} alt="Feature-Image" className='w-100 h-70 rounded-3xl box'/>
            </div>
            <div>
                <img src={New2} alt="Feature-Image" className='w-100 h-70 rounded-3xl' />
            </div>
            <div>
                <img src={New3} alt="Feature-Image" className='w-100 h-70 rounded-3xl'/>
            </div>
        </div>
    </div>
  )
